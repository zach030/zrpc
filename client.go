...
// register call to client pending pool
func (client *Client) registerCall(call *Call) (uint64, error) {
	...
	// assign current seqNo to this call
	call.Seq = client.seq
...
// remove call from client pending pool
...
func (client *Client) receive() {
	...
	for err == nil {
		...
		call := client.removeCall(h.SeqNo)
		switch {
		// 1 call not exits
		case call == nil:
		...
		// 2 error in call
		case h.ErrMsg != "":
			call.Error = fmt.Errorf(h.ErrMsg)
			err = client.cc.ReadBody(nil)
			call.done()
		default:
			// 3 success
...
func (client *Client) send(call *Call) {
	...
	client.header.SeqNo = seq
	client.header.ErrMsg = ""
